...
namespace LiteFx.Context.EntityFramework
{
    /// <summary>
    /// Entity Framework Context Base.
    /// </summary>
    /// <typeparam name="TId">Type of Entity identificador.</typeparam>
    public abstract class EntityFrameworkContextAdapter<TId> : ObjectContext, IContext<TId>
        where TId : IEquatable<TId>
    {
        public EntityFrameworkContextAdapter(string connectionString) : base(connectionString) { }
